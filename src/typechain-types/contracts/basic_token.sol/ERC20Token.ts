...
export interface ERC20TokenInterface extends utils.Interface {
  functions: {
    ...
    "puaseContract()": FunctionFragment;
    ...
    "unPuaseContract()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "puaseContract",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "unPuaseContract",
    values?: undefined
  ): string;
...
export interface ERC20Token extends BaseContract {
  ...
  functions: {
    ...
    mintToken(
      _recipient: PromiseOrValue<string>,
      _tokenToMint: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    puaseContract(overrides?: CallOverrides): Promise<void>;
    ...
    unPuaseContract(overrides?: CallOverrides): Promise<void>;
  };
